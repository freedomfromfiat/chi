...
pub fn config_endowed(
	...
	endowed.extend(
		extra_endowed.into_iter().map(|endowed| (endowed, 100*CHI))
	);
	...
	GenesisConfig {
		...
		pallet_staking: Some(StakingConfig {
			stakers: vec![
				(dave(), alice(), 111 * CHI, pallet_staking::StakerStatus::Validator),
				(eve(), bob(), 100 * CHI, pallet_staking::StakerStatus::Validator),
				(ferdie(), charlie(), 100 * CHI, pallet_staking::StakerStatus::Validator)
			],
			validator_count: 3,
